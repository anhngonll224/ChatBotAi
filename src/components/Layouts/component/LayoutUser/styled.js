...
.background-menu-box {
  background-color: #ffffff; /* Màu nền của menu box */
}

.my-account {
  background-color: #ffffff; /* Màu nền của phần tài khoản */
}


/* Thiết lập style cho menu ở chế độ dark theme */
.dark-theme .custom-menu {
  background-color: #333;
  color: #fff;
}

/* Thiết lập style cho menu ở chế độ collapsed */
.collapsed-menu .custom-menu {
  width: 80px; /* Chiều rộng của menu khi bị collapsed */
}
  position: sticky;
  top: 52px;
...
`
export const BackgroundStyledRight = styled.div`
.right-box {
    width: 100%;
}
`